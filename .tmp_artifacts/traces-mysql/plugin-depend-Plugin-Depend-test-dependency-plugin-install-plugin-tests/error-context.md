...
Received string:    "「ホライゾン (1.0.0)」を削除中。この処理には数分かかる場合があります。画面をリロードせずにこのままお待ち下さい。"

Call log:
  - Expect "toContainText" with timeout 120000ms
  - waiting for locator('#officialPluginDeleteModal').locator('.modal-body p')
    9 × locator resolved to <p class="text-start">「ホライゾン (1.0.0)」を削除中。この処理には数分かかる場合があります。画面をリロードせずに…</p>
      - unexpected value "「ホライゾン (1.0.0)」を削除中。この処理には数分かかる場合があります。画面をリロードせずにこのままお待ち下さい。"
      ...
      - generic [ref=e59]:
        - generic [ref=e60]:
          ...
          - table [ref=e65]:
            ...
            - rowgroup [ref=e74]:
              - row "ホライゾン 1.0.0 Horizon 無効 アップデート対象プラグインはありません。 削除 有効化" [ref=e75]:
                - cell "ホライゾン" [ref=e76]:
                  - generic [ref=e77]:
                    - link [ref=e78] [cursor=pointer]:
                      - /url: "#"
                    - generic [ref=e79]: ホライゾン
                - cell "1.0.0" [ref=e80]
                - cell "Horizon" [ref=e81]:
                  - paragraph [ref=e82]: Horizon
                - cell "無効" [ref=e83]
                ...
                - cell "削除 有効化" [ref=e86]:
                  - generic [ref=e87]:
                    ...
                    - link "有効化" [ref=e92] [cursor=pointer]:
                      - /url: http://127.0.0.1:8000/admin/store/plugin/1/enable
                      - generic "有効化" [ref=e94]: 
              - row "エンペラー 1.0.0 Emperor インストール" [ref=e96]:
                - cell "エンペラー" [ref=e97]:
                  - generic [ref=e98]:
                    - link [ref=e99] [cursor=pointer]:
                      - /url: "#"
                    - generic [ref=e100]: エンペラー
                - cell "1.0.0" [ref=e101]
                - cell "Emperor" [ref=e102]:
                  - paragraph [ref=e103]: Emperor
                - cell [ref=e104]
                - cell "インストール" [ref=e105]:
                  - link "インストール" [ref=e106] [cursor=pointer]:
                    - /url: http://127.0.0.1:8000/admin/store/plugin/api/install/100/confirm
                - cell [ref=e107]
          - dialog "プラグインの削除を確認する 「ホライゾン (1.0.0)」を削除中。この処理には数分かかる場合があります。画面をリロードせずにこのままお待ち下さい。 50" [ref=e108]:
            - document:
              - generic [ref=e109]:
                - heading "プラグインの削除を確認する" [level=5] [ref=e111]
                - generic [ref=e112]:
                  - paragraph [ref=e113]: 「ホライゾン (1.0.0)」を削除中。この処理には数分かかる場合があります。画面をリロードせずにこのままお待ち下さい。
                  - progressbar [ref=e115]
                  - text: 
        - generic [ref=e116]:
          - generic [ref=e117]:
            - link "アップロードして新規追加" [ref=e118] [cursor=pointer]:
              - /url: http://127.0.0.1:8000/admin/store/plugin/install
            - heading "ユーザー独自プラグイン" [level=5] [ref=e119]
          - generic [ref=e121]: インストールされているプラグインはありません。
```
